...
/**
 * Azure Functions entry point for the write side of the TODO API.
 *
 * <p>Independent class from {@code todo-read.AzureFunctionsHandler} — this
 * Function's artifact is packaged separately and does not contain any
 * {@code todo-read} classes.
 */
public class AzureFunctionsHandler {
    ...
    static {
        SYSTEM = TodoWriteSystemFactory.create();
        SYSTEM.start();
        SYSTEM.registerCrac();
    ...
    public HttpResponseMessage run(
        ...
        try {
            ...
            enkanRes = FaasErrors.toInternalServerError(ex);
        }
